...
cd
yay -Syyu --noconfirm npm spyder typescript eslint python-pip gdb gcc make maven jdk-openjdk kotlin clang llvm lld lldb libc++ cython libclc polly rustup vscodium-bin 
rustup update
